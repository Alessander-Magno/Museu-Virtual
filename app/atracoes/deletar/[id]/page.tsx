...
import DeletarAtracaoPageClient  from "./pageClient"; 
...
export default async function deletarAtracaoPageServer( Params: Params ) {
    ...
    <div className="px-30">
        ...
        <h1 className="text-4xl font-bold text-center font-serif mb-10">Informações atuais da Atração</h1>
        ...
        <DeletarAtracaoPageClient id={ id } />
